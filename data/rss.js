...
const rssData = [
 ...
 },
 {
  ...
  // 英语
   ...
   {
     title: 'HaoQi的博客',
     link: 'https://haoqiyung.ml',
     description: '本科毕业生',
     favicon: 'https://bu.dusays.com/2022/04/07/0fbc3a0195ee9.png',
     rssUrl: 'https://haoqiyung.ml/atom.xml',
     remark: '',
     detail: 'description',
   },
   {
     title: 'HaoQi',
     link: 'https://haoqiyun.tk',
     description: '一个废柴',
     favicon: 'https://s2.loli.net/2022/03/25/sxmQypOZaqHFgGY.jpg',
     rssUrl: 'https://haoqiyun.tk/atom.xml',
     remark: '',
     detail: 'description',
   },
